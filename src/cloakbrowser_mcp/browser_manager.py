...
class BrowserManager:
    ...
    async def fetch_url(
        ...
        Uses a dedicated temporary page so that multiple fetch_url calls
        can run concurrently without blocking each other or interfering
        with the main interactive page.
